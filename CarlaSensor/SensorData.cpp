...
void export_sensor_data() {
  ...
  class_<csd::VoxelDetectionEvent, bases<cs::SensorData>,boost::noncopyable, boost::shared_ptr<csd::VoxelDetectionEvent>>("VoxelDetectionEvent", no_init)              // name, and disable construction.
